...
public enum AmountModificationFormulas
{
    Additive,
    Multiplicative,
    MultiplicativeBonus,
    ValueAsPercentageOfWhole
}

public class StatModification
{
    public CharacterStat Stat;
    public Func<int, int, int, int> modFunc;
    public int percentOfStatUsed;
}
...
{
    public CharacterStatTypeSO stat;
    public AmountModificationFormulas modificationFormula;
    public int percentOfStatUsed = -1;
}

[CreateAssetMenu(menuName = "ScriptableObject/Effects/DamagingEffect")]
public class DamagingEffectSO : StatusEffectSO
{
    [Header("Stats and Tick Damage")]
    public ResourceStatAmount[] statChangePerTick;
    ...
    {
        DamagingEffect statusEffect = new DamagingEffect(this, stats);
